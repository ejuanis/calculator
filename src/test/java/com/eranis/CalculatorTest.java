...
public class CalculatorTest {
  ...
  public void multiplyTwoNumberTest() {
    ...
    assertEquals("Multiplying two numbers should return the correct value", 4, result, delta);
  }

  @Test
  public void addingThreeNumberTest() {
    double result = Calculator.calculate("1 + 2 + 3");
    assertEquals("Adding 3 numbers should return the correct value", 6, result, delta);
  }

  @Test
  public void divisionTest() {
    double result = Calculator.calculate("6 / 2");
    assertEquals("Division of 2 numbers should return the correct value", 3, result, delta);
  }
